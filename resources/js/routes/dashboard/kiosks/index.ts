 ...
 * @see app/Http/Controllers/Dashboard/Kiosk/KioskController.php:20
 ...
 * @see app/Http/Controllers/Dashboard/Kiosk/KioskController.php:33
 ...
 * @see app/Http/Controllers/Dashboard/Kiosk/KioskController.php:41
 * @route '/dashboard/kiosks'
 */
 ...
 * @see app/Http/Controllers/Dashboard/Kiosk/KioskController.php:72
 ...
 * @see app/Http/Controllers/Dashboard/Kiosk/KioskController.php:80
 ...
 * @see app/Http/Controllers/Dashboard/Kiosk/KioskController.php:90
 * @route '/dashboard/kiosks/{kiosk}'
 */
 ...
 * @see app/Http/Controllers/Dashboard/Kiosk/KioskController.php:110
 * @route '/dashboard/kiosks/{kiosk}'
 */
export const destroy = (args: { kiosk: string | number } | [kiosk: string | number ] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'delete',
} => ({
 ...
 * @route '/dashboard/kiosks/{kiosk}'
 */
destroy.url = (args: { kiosk: string | number } | [kiosk: string | number ] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { kiosk: args }
    }
 ...
 * @route '/dashboard/kiosks/{kiosk}'
 */
destroy.delete = (args: { kiosk: string | number } | [kiosk: string | number ] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'delete',
} => ({
    url: destroy.url(args, options),
