...
/**
* @see \App\Http\Controllers\Dashboard\Settings\PasswordController::edit
 * @see app/Http/Controllers/Dashboard/Settings/PasswordController.php:18
...
/**
* @see \App\Http\Controllers\Dashboard\Settings\PasswordController::update
 * @see app/Http/Controllers/Dashboard/Settings/PasswordController.php:26
 * @route '/dashboard/settings/password'
 */
